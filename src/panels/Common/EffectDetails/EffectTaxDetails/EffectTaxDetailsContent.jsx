...
const EffectTaxDetailsContent = () => {
  ...
  return (
    <div className="EffectTaxDetailsContent">
      <Cell
        multiline
        description={(`Мозговой налог списывается с Вашего счета в размере ${tax} монет, каждый день. Прохождение мозгового отчета позволяет Вам не платить налог. Включите напоминания об отчётах в главном меню.`)}
      />
    </div>
  );
};
