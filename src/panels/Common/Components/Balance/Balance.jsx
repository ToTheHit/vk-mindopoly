...
import './balance.css';
import {
  HorizontalScroll, Text, Title, Tooltip,
} from '@vkontakte/vkui';
...
const Balance = (props) => {
  const {
    coins, GP, effects, popoutMainView,
  } = props;
    ...
    <div className="Balance">
      ...
      <div className="Balance__row">
        ...
        <Tooltip
          ...
          onClose={() => onCloseTooltipBalance(1)}
        >
          <div />
        </Tooltip>
        ...
        <div className="Balance__item">
          ...
          >
            <g
              ...
              fillRule="evenodd"
            >
              <g id="Icons-28/brain_outline_28Balance" transform="translate(3.000000, 3.000000)">
