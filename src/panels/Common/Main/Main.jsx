...
import EffectsRow from './Components/EffectsRow/EffectsRow';
          ...
          bridge.send('VKWebAppGetUserInfo', {})
            .then((bridgeData) => {
              const user = {
                ...
                photo_100: bridgeData.photo_100,
                GP: srvData.bp,
                ...
                effectsArray.push(
                  {
                    ...
                    icon: (
                      ...
                      >
                        ...
                        >
                          <g
                            id="Icons-28/compass_outline_28-@-explore"
                            transform="translate(2.000000, 2.000000)"
                          >
  ...
  return (
    <Panel id={id} className="Main">
      <PanelHeader
        ...
        separator={false}
        left={(
          <div className="Main__header--content" style={{ opacity: (popoutMainView ? '0' : '1') }}>
            <Avatar className="Main__photo" src={userInfo.photo_100} size={32} />
            <Text className="Main__name" weight="regular">{userInfo.first_name}</Text>
          </div>
        )}
      >
        {/* Мозгополия */}
